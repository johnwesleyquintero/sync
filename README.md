...
This course is divided into multiple modules, each covering different aspects of building the Sync app. The modules include:
...
Watch the full course on YouTube: [Ultimate Next.js 15, Typescript and Supabase Course: Build a Full-Featured Sync App](https://youtu.be/3D8Q_BMurfs)

Part 2
Watch the full course on YouTube: [Ultimate Next.js 15, Typescript and Supabase Course: Build a Full-Featured Sync App](https://youtu.be/LX3zttE15s4)
